<?php
    // hcpViewPHR.php
    // HCP viewing a PHR they have access to
    session_start();
    ...
    for($i = 0; $i < $size; $i++){
        ...
        // PERSONAL INFO
        if($personalInfoBool){
            $personalinfofname = $pieces[$i];
            if($personalinfofname == "null"){
                $personalinfofname = "";
            }
            $personalinfolname = $pieces[$i + 3];
            if($personalinfolname == "null"){
                $personalinfolname = "";
            }
            $personalinfogender = $pieces[$i + 5];
            if($personalinfogender == "null"){
                $personalinfogender = "";
            }
            $personalinfoage = $pieces[$i + 7];
            if($personalinfoage == "null"){
                $personalinfoage = "";
            }
            $personalinfobirthday = $pieces[$i + 9];
            if($personalinfobirthday == "null"){
                $personalinfobirthday = "";
            }
            $personalinfophone = $pieces[$i + 11];
            if($personalinfophone == "null"){
                $personalinfophone = "";
            }
            $personalinfoemail = $pieces[$i + 13];
            if($personalinfoemail == "null"){
                $personalinfoemail = "";
            }
            $personalinfocity = $pieces[$i + 15];
            if($personalinfocity == "null"){
                $personalinfocity = "";
            }
            $personalinfoprovince = $pieces[$i + 17];
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            if($viewphrPDF){
                ...
                $sql = mysqli_query($connection_mysql,"SELECT * FROM patientinfo WHERE patientid = " .$patientid);
...
<html>
    <head>
        ...
        <link rel = "stylesheet" href="../css/hcpViewPHR.css">
    ...
    <body>
        <form method="POST">
            <header>
                <div class="container">
                    <a href="?code=8"><span><img id="logo" src="../images/hc.jpg"></span></a>
                    <nav>
                        <a href="?code=8">Healthchain</a>
            ...
            <div class="sidebar">
                <a href="?code=8"><img class = "userPic" src = "../images/hc.jpg" width = "25px" height = "25px"><div class = "sidebarContent">&nbsp  &nbsp Healthchain</div></a>
                <div class="sidebarMiddleContent">
                    <a href="?code=1" class="active"> <i id="contentSidebar" class="fa fa-eye"></i> <div class = "sidebarContent">&nbsp  &nbsp View PHRs</div></a>
