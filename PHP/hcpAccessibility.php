...
<html>
    <head>
        ...
        <link rel = "stylesheet" href="../css/hcpAccessibility.css">
    ...
    <body>
        <form method="POST">
            ...
            <div class="sidebar">
                <a href="?code=6"><img class = "userPic" src = "../images/hc.jpg" width = "25px" height = "25px"><div class = "sidebarContent">&nbsp  &nbsp Healthchain</div></a>
