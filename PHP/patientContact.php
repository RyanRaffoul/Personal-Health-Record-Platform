...
<html>
    <head>
        ...
        <link rel = "stylesheet" href="../css/patientContact.css">
    ...
    <body>
        <form method="POST">
            <header>
                <div class="container">
                    <a href="?code=10"><span><img id="logo" src="../images/hc.jpg"></span></a>
                    <nav>
                        <a href="?code=10">Healthchain</a>
            ...
            <div class="sidebar">
                <a href="?code=10"><img class = "userPic" src = "../images/hc.jpg" width = "25px" height = "25px"><div class = "sidebarContent">&nbsp  &nbsp Healthchain</div></a>
            ...
            <div class="middleContent">   
                ...
                <a href="mailto: ryanraffoul1@hotmail.com">
                    <div class="about">
                        <p>Please Contact Here: ryanraffoul1@hotmail.com or raffoulr@uwindsor.ca</p>
                    </div>
                </a>
                <div class = "footer">
