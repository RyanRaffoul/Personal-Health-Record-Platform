...
<html>
    <head>
        ...
        <link rel = "stylesheet" href="../css/hcpContact.css">
    ...
    <body>
        <form method="POST">
            ...
            <div class="sidebar">
                <a href="?code=7"><img class = "userPic" src = "../images/hc.jpg" width = "25px" height = "25px"><div class = "sidebarContent">&nbsp  &nbsp Healthchain</div></a>
