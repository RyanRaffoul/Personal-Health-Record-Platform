<?php
    // generatePatientPHR.php
    // Generate the PHR and add to Blockchain and DB
    session_start();
    ...
    $patientPHR = $_SESSION['patientPHR'];
    $bool = false;
    ...
    $sql = "INSERT INTO patientphr(patientid, publickey, encryptedphr) VALUES (" .$userid .", '" .$publicKey ."','" .$encryptedData ."')";
...
<script type="text/javascript">
    <?php if($bool){ ?>
                ...
                try{
                    // add to blockchain and go to home page
